...
//Written by: Zafir Anjum CodeGeru.com
...
/////////////////////////////////////////////////////////////////////////////////////
// FindNoCase	- Case insensitive find
// Returns		- A zero-based index// lpszSub	- Substring to search for
// startpos 	- Position to start looking from
...
// Returns		- Number of instances replaced// lpszSub		- Substring to look for
...
// Returns			- The number of fields
//					  Is always greater than zero
// delim		- The delimiter stringint 
CStringEx::GetFieldCount( LPCTSTR delim )
{
