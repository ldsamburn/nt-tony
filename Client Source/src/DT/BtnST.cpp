...
void CButtonST::SetIcon(int nIconInId, int nIconOutId)
{
	HICON hIconIn;
	HICON hIconOut;
	//jj commented out next line & put NULL in first param to LoadImage
	...
	hIconOut = (nIconOutId == NULL) ? NULL : (HICON)::LoadImage(hInstResource, MAKEINTRESOURCE(nIconOutId), IMAGE_ICON, 0, 0, 0);
