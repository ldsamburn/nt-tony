...
BOOL CTextRotator::RotateText(UINT uiAngle)
 {
  ...
  switch(uiAngle)
   {
    case  90 :
               stPoints[0].x = rectFull.Height();
               stPoints[0].y = 0;
               stPoints[1].x = rectFull.Height();
               stPoints[1].y = rectFull.Width();
               stPoints[2].x = 0;
               stPoints[2].y = 0;
               break;

    case 180 :
               stPoints[0].x = rectFull.Width();
               stPoints[0].y = rectFull.Height();
               stPoints[1].x = 0;
               stPoints[1].y = rectFull.Height();
               stPoints[2].x = rectFull.Width();
               stPoints[2].y = 0;
               break;

    case 270 :
               stPoints[0].x = 0;
               stPoints[0].y = rectFull.Width();
               stPoints[1].x = 0;
               stPoints[1].y = 0;
               stPoints[2].x = rectFull.Height();
               stPoints[2].y = rectFull.Width();
               break;

    default  :
               stPoints[0].x = 0;
               stPoints[0].y = 0;
               stPoints[1].x = rectFull.Width();
               stPoints[1].y = 0;
               stPoints[2].x = 0;
               stPoints[2].y = rectFull.Height();
               break;
   }

  // Rotate the memory DC
  PlgBlt(m_hRotatedMemDC,
